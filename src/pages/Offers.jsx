...
const Offers = () => {
    ...
    const sortedOffers = useMemo(() => {
        ...
        switch(sortCriteria) {
            ...
            case 'price-low':
                return sorted.sort((a, b) => parsePrice(a.discountedPrice) - parsePrice(b.discountedPrice));
            case 'price-high':
                return sorted.sort((a, b) => parsePrice(b.discountedPrice) - parsePrice(a.discountedPrice));
            default:
                return sorted;
        }
    ...
    const shareOffer = async (offer) => {
        const shareText = `${offer.title} - ${offer.description} Check out this amazing travel offer from MoonRail!`;
    ...
    return (
        <div className="offers-page">
            ...
            <div className="wishlist-buttons">
                <button className="wishlist-btn" onClick={addAllToWishlist} data-action="add-all">
                    <i className="far fa-heart"></i> Add All to Wishlist
                </button>
                <button className="wishlist-btn" onClick={viewWishlist} data-action="view">
                    ...
                    {sortedOffers.map(offer => {
                        ...
                        return (
                            <div
                                ...
                                data-popularity={offer.popularity}
                                data-savings={offer.savings}
                            >
                                {offer.badge && (
                                    <div className={`offer-badge ${
                                        offer.badge === 'HOT DEAL' ? 'hot-deal' :
                                        offer.badge === 'EXCLUSIVE' ? 'exclusive' :
                                        offer.badge === 'LAST CHANCE' ? 'last-chance' : ''
                                    }`}>
                                        {offer.badge}
                                    </div>
                                )}
                                ...
                                <div className="offer-details">
                                    ...
                                    <div className="price-comparison">
                                     ...
                                     <span className="savings">Save ₹{offer.savings?.toLocaleString() || '0'}</span>
                                    </div>
                                    ...
                                    <div className="offer-meta">
                                        <div className="validity">Until: {new Date(offer.expiry).toLocaleDateString('en-GB')}</div>
                                        <button 
